...
in {
  ...
  config = mkIf cfg.enable {
    ...
    home.file.".config/zsh/.zshrc" = {
      source = mkOutOfStoreSymlink "/home/syg/.config/nixos/dotfiles/dot_config/zsh/zshrc";
      force = true;
    };

    home.file.".config/zsh/plugins.txt" = {
      source = mkOutOfStoreSymlink "/home/syg/.config/nixos/dotfiles/dot_config/zsh/plugins.txt";
      force = true;
    };

    home.file.".config/zsh/plugins.zsh" = {
      source = mkOutOfStoreSymlink "/home/syg/.config/nixos/dotfiles/dot_config/zsh/plugins.zsh";
      force = true;
    };
  };
}
